...
sed -i 's/192.168.2.1/192.168.124.1/g' package/base-files/files/bin/config_generate

# 修改主机名字，把ImmortalWrt修改你喜欢的就行（不能纯数字或者使用中文）
sed -i 's/LEDE/H3C TX1800-Plus/g' package/base-files/files/bin/config_generate

# 修改闭源驱动2G wifi名称
sed -i 's/SSID1=CR660X_2.4G/SSID1=H3C_TX1800-Plus/g' package/mtk/luci-app-mtwifi/files/mt7615.1.2G.dat

# 修改闭源驱动5G wifi名称
sed -i 's/SSID1=Openwrt_5G/SSID1=H3C_TX1800-Plus-5G/g' package/mtk/luci-app-mtwifi/files/mt7615.1.5G.dat
